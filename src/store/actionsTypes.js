...
const REMOVE_SELECTED_TABLE_ROW_FROM_STORE = "REMOVE_SELECTED_TABLE_ROW_FROM_STORE";
const FETCH_FINAL_REPORT_DATA = "FETCH_FINAL_REPORT_DATA";
...
export default {
  ...
  // Final report
  FETCH_FINAL_REPORT_DATA,
  ADD_ROW,
  REMOVE_SELECTED_TABLE_ROW,
  REMOVE_SELECTED_TABLE_ROW_FROM_STORE,
